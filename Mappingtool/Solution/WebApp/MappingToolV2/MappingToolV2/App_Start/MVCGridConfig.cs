[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(MappingToolV2.MVCGridConfig), "RegisterGrids")]

namespace MappingToolV2
{
    using System;
    using System.Web;
            ...
            MVCGridDefinitionTable.Add("RBACMarkedAsDelete", new MVCGridBuilder<listrbacpermconfig>()
                ...
                .AddColumns(cols =>
                {
                    ...
                    cols.Add("Delete").WithHtmlEncoding(false)
                        .WithSorting(false)
                        .WithHeaderText(" ")
                        .WithValueExpression((p, c) => c.UrlHelper.Action("RBACMarkedasDelete_Delete", "AdminTools", new
                        {
                            AADGroupName = p.AADGroupName,
                            AADGroupID = p.AADGroupID,
                            AzureRG = p.AzureRG,
                            SubscriptionID = p.SubscriptionID,
                            ADGroupName = p.ADGroupName,
                            ADGroupSID = p.ADGroupSID,
                            ADOUPath = p.ADGroupDN,
