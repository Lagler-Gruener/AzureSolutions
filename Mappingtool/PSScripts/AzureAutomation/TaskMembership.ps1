                    ...
                    Write-Output "Set message invisible timeout to 90 seconds"
                        ...
                        if($null -ne $queueMessage)
                        {
                            ...
                            foreach ($user in $result.ADGroupMembers) {
                                ...
                                $resultsynccheck = Check-is-user-synced -upn $user.UserPrincipalName -AADTenantID $loginazureresult.ReturnParameter1
                            ...
                            foreach ($member in $aadgroupmembers) {  
                                ...
                                $resultsynccheck = Check-is-user-synced -upn $member.UserPrincipalName -AADTenantID $loginazureresult.ReturnParameter1
                                Write-Output $resultsynccheck.LogMsg
